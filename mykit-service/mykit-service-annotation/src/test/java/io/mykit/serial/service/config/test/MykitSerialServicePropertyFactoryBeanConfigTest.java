...
import io.mykit.serial.service.config.MykitSerialServicePropertyFactoryBeanConfig;
 ...
 * @description 测试
 */
public class MykitSerialServicePropertyFactoryBeanConfigTest extends BaseTest {
    @Before
    public void init(){
        applicationContext = new AnnotationConfigApplicationContext(MykitSerialServicePropertyFactoryBeanConfig.class);
    }
