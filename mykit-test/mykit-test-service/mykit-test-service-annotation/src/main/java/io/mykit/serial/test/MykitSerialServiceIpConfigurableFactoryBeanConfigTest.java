...
import io.mykit.serial.service.config.MykitSerialServiceIpConfigurableFactoryBeanConfig;
 ...
 * @description 测试
 */
public class MykitSerialServiceIpConfigurableFactoryBeanConfigTest extends BaseTest {

    @Before
    public void init(){
        applicationContext = new AnnotationConfigApplicationContext(MykitSerialServiceIpConfigurableFactoryBeanConfig.class);
    }
