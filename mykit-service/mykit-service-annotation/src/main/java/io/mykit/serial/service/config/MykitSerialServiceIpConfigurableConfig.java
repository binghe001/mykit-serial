 ...
 */
@Configuration
public class MykitSerialServiceIpConfigurableConfig {

    @Bean(name = {"ipConfigurableMachineSerialNumberProvider"},initMethod = "init")
    public IpConfigurableMachineSerialNumberProvider ipConfigurableMachineSerialNumberProvider(){
        IpConfigurableMachineSerialNumberProvider ipConfigurableMachineSerialNumberProvider = new IpConfigurableMachineSerialNumberProvider();
        ipConfigurableMachineSerialNumberProvider.setIps(PropLoader.getStringValue(PropLoader.MYKIT_SERIAL_IPS));
        return ipConfigurableMachineSerialNumberProvider;
    }
