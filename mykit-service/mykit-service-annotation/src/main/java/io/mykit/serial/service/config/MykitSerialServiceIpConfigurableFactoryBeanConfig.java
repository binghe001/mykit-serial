 ...
 * @author binghe
 * @version 1.0.0
 * @description FactoryBean Config
 */
@Configuration
public class MykitSerialServiceIpConfigurableFactoryBeanConfig {
    ...
    public SerialNumberServiceFactoryBean serialNumberService(){
        ...
        serialNumberService.setProviderType(StoreType.IP_CONFIGURABLE);
        serialNumberService.setIps(PropLoader.getStringValue(PropLoader.MYKIT_SERIAL_IPS));
