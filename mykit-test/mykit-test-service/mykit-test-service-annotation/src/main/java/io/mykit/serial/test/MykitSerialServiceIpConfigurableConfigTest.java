...
import io.mykit.serial.service.config.MykitSerialServiceIpConfigurableConfig;
 ...
 * @description 测试
 */
public class MykitSerialServiceIpConfigurableConfigTest extends BaseTest {

    @Before
    public void init(){
        applicationContext = new AnnotationConfigApplicationContext(MykitSerialServiceIpConfigurableConfig.class);
    }
