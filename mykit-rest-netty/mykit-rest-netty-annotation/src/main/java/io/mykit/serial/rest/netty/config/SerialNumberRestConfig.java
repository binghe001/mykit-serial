...
public class SerialNumberRestConfig {
    ...
    public SerialNumberServiceFactoryBean serialNumberService(){
        SerialNumberServiceFactoryBean serialNumberService = new SerialNumberServiceFactoryBean();
        serialNumberService.setProviderType(StoreType.PROPERTY);
        serialNumberService.setMachineSerialNumber(PropLoader.getIntegerValue(PropLoader.MYKIT_SERIAL_MACHINE));
        serialNumberService.setGenMethod(PropLoader.getIntegerValue(PropLoader.MYKIT_SERIAL_GENMETHOD));
